        ...
        while ($menuCargarDatos == 1 || $menuCargarDatos == 2 || $menuCargarDatos == 3) {
            ...
            if ($menuCargarDatos == 1) {
                ...
                if ($contViaje != 0) {
                    ...
                    //verifica que el pasajero exista
                    $pasajeroExiste = true;
                    ...
                    echo "\e[41mNo se cargó un viaje previamente, por favor volver al menú y seleccione un viaje.\e[0m"."\n";
                }
            ...
            //carga el responsable
                ...
                if($contViaje != 0){
                    ...
                    echo "Ingrese el número del responsable:";
    ...
    //menu modificar datos
        ...
        while ($menuModificarDatos == 1 || $menuModificarDatos == 2 || $menuModificarDatos == 3) {
            ...
            if ($menuModificarDatos == 1) {
                ...
                //Verifica que exista almenos 1 pasajero
                if($pasajeroExiste){
                    ...
                    if ($objAEncontrar instanceof PasajeroNecesidadesEspeciales) {
                        ...
                        echo "Ingrese el número de documento del pasajero a cambiar:";
                        ...
                        echo "Ingrese su número de viajero frecuente a cambiar:";
                        ...
                        echo "Ingrese el número de documento a cambiar:";
                        ...
                        echo "Ingrese el número de asiento a cambiar :";
                        ...
                        echo "\e[41mEl ticket que ingresó no es está registrado en la base de datos\e[0m"."\n";  
                    }
                }else{
